...
- Target iOS 26.0 or later, but still maintaining compatibility is important with iOS 18.0 onwards.
- Swift 6.2 or later preferred, using modern Swift concurrency. Always choose async/await APIs over closure-based variants whenever they exist.
